<template>
  <PageComponent title="Contas a Pagar" subtitle="Registro, Faturamento e Acompanhamento Detalhado das Despesas Pendentes.">
    ...
    >
      <template v-slot:top>
        ...
        />
        <q-space />
        <q-input outlined dense debounce="300" color="primary" v-model="filter" class="q-pa-sm" label="Pesquisar">
          <template v-slot:append>
            <q-icon name="search" label="Pesquisar" />
          </template>
        </q-input>
      </template>
